...
function ExchangeManager() {
    ...
    const getFullExchangeName = (cfg, exchangeName) => {
    ...
    const setupDirectExchange = (cfg, logger, connection, exchange, exchangeName, isSetup) => {

        return new Promise((resolve,reject) => {

            const fullExchangeName = getFullExchangeName(cfg, exchangeName);
        ...
        return new Promise((resolve, reject) => {
            ...
            connection.on('ready', () => {
                ...
                if (isSetup) {
                    ...
                    let exchangeFullName = getFullExchangeName(cfg, exchangeName),
                        promise;
                    ...
                    exchange = connection.exchange(exchangeFullName, cfg.producer.exchange.options, () => {
                        ...
                        switch (cfg.producer.exchange.options.type) {
                            case 'fanout':
                                ...
                                break;
                            case 'direct':
                                promise = setupDirectExchange(cfg, logger, connection, exchange, exchangeName, isSetup);
                                break;
                            default:
                                reject(new Error("Unknown Exchange type"));
                                return;
                        ...
                        promise
                            .then(() => {
                                ...
                                exchangeProducers.set(exchangeName, exchange);
    ...
    return {
        ...
        getExchange,
        getMap: () => {
            return exchangeProducers;
        }
    }
}

const exchangeManager = new ExchangeManager();console.log('exchangeManager')
